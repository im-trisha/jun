...
use crate::common::{Color, SpecialVariablesHolder};
use crate::email::{LegacyEmail, NewEmail};
use crate::events::EventsState;
use crate::item::ItemsState;
use crate::managers::{
...
use crate::save::dialogue_chain::DialogueChains;
...
pub struct GameVariables {
    ...
    pub seen_dialogue_chains: DialogueChains,
    ...
    ///
    /// [GameVariables.max_cum] - [GameVariables.remaining_cum] will give you the missing sperm (in mL)
    ...
    /// Number of stage-conversations remaining (e.g. [GameVariables.unique_conversations_left] + [GameVariables.stage] is the last stage you will reach)
